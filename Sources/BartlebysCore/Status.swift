...
extension Int {
    ...
    public func status() -> Status {
        return Status.from(httpStatus: self)
    }
...
public enum Status : Int {
    ...
    public static func from(httpStatus : Int) -> Status {
        return Status(rawValue: httpStatus) ?? Status.error
    }
    
    public static func messageFromStatus(_ status: Status ) -> String {
